...
- Focus on flushing out all the bugs in the codegen, and then focus on vm
  - [x] redesign the ISA, a lot of bloat instructions that can be avoided
  - [x] move away from purely stack based design into more register based design
  - [x] ideally take inspiration from or entirely emulate an alreay existing CPU of similar power
    - Arm Thumb
