...
echo "assembling stdlib/print.masm -> stdlib/print.mobj"
cargo run --package assembler -q -- stdlib/print.masm -o stdlib/print.mobj || exit 1
...
echo "linking $OUT_DIR/$BASENAME.mobj + stdlib/print.mobj + stdlib/math.mobj -> $OUT_DIR/$BASENAME.mbin"
cargo run --package linker -q --  "$OUT_DIR/$BASENAME.mobj" stdlib/print.mobj stdlib/math.mobj -o "$OUT_DIR/$BASENAME.mbin" || exit 1
